...
import 'package:onboarding_app/screens/onboarding/pages/community/community_dark_card_content.dart';
import 'package:onboarding_app/screens/onboarding/pages/community/community_light_card_content.dart';
import 'package:onboarding_app/screens/onboarding/pages/community/community_text_column.dart';
...
class OnboardingPageIndicator extends StatelessWidget {
  ...
  const OnboardingPageIndicator({
    ...
    required int number,
    required lightCardOffsetAnimation,
    required darkCardOffsetAnimation,
    required textColumn,
